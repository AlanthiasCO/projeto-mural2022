...
public enum Resposta {
	...
	FORMATO_DATA_INVALIDO("formato-data-invalido"), LEMBRETE_NAO_ENCONTRADO("lembrete-nao-existe"),
	COMENTARIO_NAO_EXISTE("comentario-nao-existe"), COMENTARIO_NAO_CRIADO_PELO_USUARIO_LOGADO("sem-permissao");
